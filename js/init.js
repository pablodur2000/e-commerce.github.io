const CATEGORIES_URL = "http://localhost:5500/api/cats";
const PUBLISH_PRODUCT_URL = "https://japceibal.github.io/emercado-api/sell/publish.json";
const PRODUCTS_URL = "http://localhost:5500/api/cat/";
const PRODUCT_INFO_URL = "http://localhost:5500/api/products";
const PRODUCT_INFO_COMMENTS_URL = "http://localhost:5500/api/productsComments/";
