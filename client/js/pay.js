...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const realizarPago = async (event) =>{
      ...
      if (allPagoFieldsCompleted) {
        await fetch("https://e-commerce-server-eight-mu.vercel.app/api/addCart", {
  ...
  document.getElementById("realizar-pago-btn").addEventListener("click", (e) => { realizarPago(e)});
  document.getElementById("finalizar-compra-btn").addEventListener("click", (e) => { realizarPago(e)});
